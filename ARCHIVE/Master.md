...
#2025-03-24,ANIMALS,Dogs,PET,unusual discomfort and restlessness"A Reddit user states their dog was acting weird and couldn't get comfortable before leaving the bed, prompting several replies sharing similar recent experiences.","https://www.reddit.com/r/strange/comments/1jjdy7q/dogs_acting_weird/",
#2025-07-03,ANIMALS,Coyotes,WILDLIFE,increased urban interactions and protective/aggressive denning"Coyote Yipps blog documents urban residents reporting increased coyote activity around denning areas; blog also links to Instagram stories and direct contact from people with recent encounters.","https://coyoteyipps.com/#2025/07/",
#2025-06-05,ANIMALS,Deer,WILDLIFE,unexpected aggressive or startled encounter"TikTok user filmed a strikingly odd interaction with a deer that appeared disturbed and reactive; thousands commented on similar wildlife encounters this summer.","https://www.tiktok.com/@mndiaye_97/video/7512889372853718314",
...
#2025-08-01,CIVIL/SOCIAL,Online Toxicity,UK Summer Riots spike in hate speech and disinformation in the UK on X & Telegram, Perplexity's Social Media Analysis,
...
#2025-08-01,TRANSIT,Vehicle recall,electronic brake booster,120 vehicles affected,
#2025-08-01,CIVIL/SOCIAL,Social Media Trends,Global trends service outage,
#2025-08-01,CIVIL/SOCIAL,UK Summer Riots & Disinformation Spike,Spike in hate speech on X/Telegram linking unrest to Israel-Hamas conflict,
...
#2025-08-16,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-17,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-18,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-19,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
#2025-08-19,LLM,OpenAI,Vector Stores,Elevated Errors for File Uploads to Vector Stores,
#2025-08-20,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-21,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
#2025-08-22,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
#2025-08-22,LLM,OpenAI,API,Elevated API errors and latencies,
#2025-08-23,ELECTRONICS,RC aircraft ESC failure,,
#2025-08-23,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-24,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
#2025-08-25,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-26,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-27,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-28,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-29,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-30,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-08-31,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-09-01,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-09-02,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-09-03,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-09-04,LLM,Anthropic Model Degradation,Model output quality issues,Resolved
...
#2025-09-08,LLM,OpenAI API Latency Issues,Users reported elevated latency and 5xx errors for GPT-4 models across multiple regions.,
...
#2025-09-09,TRANSIT,Railway Signal System Malfunction,Widespread signal failures reported on the Northeast Corridor, causing significant delays.,
...
#2025-09-14,ACTofGOD,Electron Flux Alert,18:51 UTC,Continued alert: Electron 2MeV integral flux exceeded 1000 pfu,
...
#2025-10-02,LLM,OpenAI,Login Issues,Users cannot login or create new accounts,Resolved
#2025-10-02,LLM,OpenAI,Android Signup Errors,Increased errors on Google signup for Android users,Resolved
#2025-10-04,LLM,Google,Batch API Outage,Gemini Batch API experienced outage,Resolved
#2025-10-08,LLM,Google,Multiple Batch API Outages,Multiple outages reported for Gemini Batch API throughout the day,Resolved
#2025-10-08,LLM,OpenAI,Service Degradation,General service degradation affecting multiple components,Resolved
#2025-10-09,LLM,Google,API Outages,Google AI Studio Realtime and Gemini Live API affected by outage,Resolved
#2025-10-09,LLM,OpenAI,Assistants API Issues,Assistants API experiencing issues,Resolved
#2025-10-10,LLM,OpenAI,Connector Errors,Elevated error rates for Gmail and Google Calendar connectors,Resolved
#2025-10-10,LLM,OpenAI,Responses API Outage,Partial outage of Responses API,Resolved
#2025-10-11,ACTofGOD,Geomagnetic Forecast,G1 Storm Forecast,G1 minor geomagnetic storms forecast for Oct 12 due to coronal hole high speed stream,
#2025-10-11,LLM,OpenAI,SDK Dev Mode Outage,Apps SDK Dev Mode experiencing partial outage,Resolved
#2025-10-11,LLM,OpenAI,Chat Function Broken,Temporary chat not functioning on web interface,Resolved
#2025-10-13,LLM,OpenAI,Fine-Tuning Delays,Delays with Supervised Fine-Tuning jobs,Resolved
...
#2025-10-14,LLM,OpenAI,Model Error Rates,Elevated error rates in gpt-5-mini model,Resolved
#2025-10-12,CRIME,Hit-and-run fatality,In Oregon,
...
#2025-10-02,LLM,Anthropic,Connectors Unhealthy,Users unable to connect to Claude.ai Connectors/MCP, investigating started 16:47 UTC Resolved,
...
#2025-10-07,ACTofGOD,SHUMANN,Full Whiteout,Chart maxed out; likely sensor saturation or elevated lightning activity,
#2025-10-09,LLM,Anthropic,Elevated errors - claude.ai,Elevated errors on claude.ai. Resolved at Oct 10 00:34 UTC,status.anthropic.com,Issue identified at 21:23 UTC on Oct 9. Fix implemented at 21:44 UTC,
#2025-10-12,ACTofGOD,SHUMANN,Vertical Blackout,Sudden data loss or frequency drop,
#2025-10-13,ACTofGOD,SHUMANN,Vertical Blackout,Sudden data loss or frequency drop,
...
#2025-10-20,LLM,ept AI,AWS us-east-1 outage - continues,AWS us-east-1 outage continues affecting ept AI services. Resolved at 13:17 PDT,status.ept.ai,Solar: Kp 2-3 unsettled. 48hrs after G2 storm peak
#2025-10-20,LLM,ept AI,AWS us-east-1 outage,ept AI services showing degraded performance due to AWS outage. Resolved at 11:32 PDT,status.ept.ai,Solar: Kp 2-3. Post-storm period
#2025-10-20,LLM,ept AI,Websocket outage,Complete websocket outage due to underlying AWS service outage. Resolved at 03:03 PDT,status.ept.ai,Solar: Kp 2-3. AWS-related
#2025-10-20,LLM,ept AI,Generator down,Generator down due to LLM provider outage and AWS service degradations. Resolved at 02:58 PDT,status.ept.ai,Solar: Kp 2-3. LLM API provider issue. ~36hrs after G2 storm
#2025-10-20,LLM,Anthropic,Claude.ai unavailable,Claude.ai completely unavailable due to faulty edge proxy deployment. Resolved at 18:12 UTC,status.anthropic.com,Solar: Kp 2-3. Faulty deployment rolled back. ~48hrs after G2 storm
#2025-10-23,LLM,Anthropic,Claude outage,Claude unavailable for several hours,personal/user report,Solar: Kp 1-2 QUIET. ~96hrs after G2 storm. Lagging effect?
#2025-10-23,NETWORK,Discord,Possible outage,Discord reported as not working by users but no offic